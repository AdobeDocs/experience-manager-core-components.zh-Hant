...
格式索引標籤可讓您指定預設和自訂日期格式。 此外，您還可以使用「**新增**」按鈕新增自訂日期格式。
...
2. 在「**允許的元件**」區段中，選取「**[!UICONTROL 日期挑選器]**」元件。
   ![日期挑選器範本原則](/help/adaptive-forms/assets/date-picker-policy.png)
3. 按一下「**[!UICONTROL 新增]**」圖示，為日期挑選器元件建立新原則。
