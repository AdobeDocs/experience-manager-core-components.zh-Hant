...
使用者按一下索引標籤時，表單內容會動態更新，以顯示對應的區段。
...
自適應表單垂直索引標籤核心元件作為核心元件 2.0.18 的一部分發行。 下表顯示所有支援版本、AEM 相容性以及對應文件的連結：

|  |  |
|---|---|
| 元件版本 | AEM as a Cloud Service |
| --- | --- |
| v1 | 與 <br>[2.0.18 版](/help/adaptive-forms/version.md)及更高版本相容\|相容\|相容 |
