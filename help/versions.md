...
核心元件的目前發行版本是2.23.4，與相容 [AEMas a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html) 和 [內部部署AEM](https://experienceleague.adobe.com/docs/experience-manager-65/user-guide/home.html) 安裝。
...
| [2.22.6](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.22.6) | 此修補程式版本修正 [容器元件。](/help/components/container.md) | - | 6.5.14.0+ | 持續 | 8, 11 | 2023 年 4 月 21 日 |
...
| [2.22.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.22.0) | 此發行版本推出新版本的 [清單元件](/help/components/list.md) 以及功能改進 [Teaser](/help/components/teaser.md) 和更新 [PDF檢視器](/help/components/pdf-viewer.md) 和 [輪播](/help/components/carousel.md) | - | 6.5.14.0+ | 持續 | 8, 11 | 2023年2月9日 |
...
| [2.18.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.18.0) | 核心元件的這個主要發行版本，介紹了跨多個元件的新版本的新連結處理常式，以及許多協助工具改進和錯誤修正。 | - | 6.5.10.0+ * | 持續 | 8, 11 | 2022年2月16日 |
...
| [2.14.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.14.0) | 此版本包含 [內嵌元件](/help/components/embed.md) 並介紹此網站的Brand Slug [頁面](/help/components/page.md) 並解決許多問題。 | 6.4.8.1+ | 6.5.5.0+ | 持續 | 8, 11 | 2021年2月9日 |
...
| [2.13.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.13.0) | 此發行版本包含適用於的新Dynamic Media功能 [影像元件。](/help/components/image.md) | 6.4.8.1+ | 6.5.5.0+ | 持續 | 8, 11 | 2020年12月4日 |
...
| [2.3.2](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.3.2) | 此版本著重於對以下專案的細化： [元件庫，](https://aemcomponents.dev) 但也包含一些功能增強功能， [分隔符號元件。](/help/components/separator.md) | 6.4.2.0+ | 6.5.0.0+ | 持續 | 8 | 2019年3月14 |
| [2.3.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.3.0) | 此版本著重於 [元件資料庫](https://aemcomponents.dev) 以及介紹全新的 [分隔符號元件，](/help/components/separator.md) 但也包含一些功能增強功能， [影像元件。](/help/components/image.md) | 6.4.2.0+ | - | - | 8 | 2019年2月11日 |
...
| [2.0.4](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.0.4) | 此發行版本主要針對底層改善、錯誤修正，以及一些小幅度改進 [影像元件，](/help/components/image.md) [頁面元件，](/help/components/page.md) 和 [內容片段元件。](/help/components/content-fragment-component.md) | 6.4.0.0+ | - | - | 8 | 2018年3月7 |
...
| [1.0.0](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-1.0.0) | 核心元件的初始發行版本。 | 6.4.0.0+ | - | - | 7 | 2017年3月20 |
