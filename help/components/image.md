...
內容作者可以使用 [編輯對話方塊](#edit-dialog) 編輯影像資產，例如套用裁切或旋轉影像。

範本作者可以在下列位置定義影像寬度和其他設定： [設計對話方塊](#design-dialog). 內容編輯者可上傳或選取 [設定對話方塊。](#configure-dialog)
...
有關影像元件的最新技術檔案 [在GitHub上可找到](https://adobe.com/go/aem_cmp_tech_image_v3).
...
* 開啟縮放滑桿
  ...
  ![縮放顯示滑桿控制項](/help/assets/image-zoom-slider.png)
...
![影像元件之「設定」對話方塊的「資產」標籤](/help/assets/image-configure-asset.png)

* **從頁面繼承精選影像**  — 此選項使用 [連結頁面的精選影像](page.md) 或未連結影像時目前頁面的精選影像。
...
>[!TIP]
>
>檢視檔案 [自我調整影像Servlet](/help/developing/adaptive-image-servlet.md) 提供透過仔細定義寬度來最佳化轉譯選擇的秘訣。
