...
使用設計對話框，範本作者可以設定搜尋在內容樹狀結構中的開始位置預設值，以及結果集大小上限和搜尋字詞最小長度。設計對話框可讓範本作者定義可供內容作者使用的文字格式選項。
...
>[!NOTE]
>
>**結果大小**&#x200B;和&#x200B;**搜尋字詞最小長度**&#x200B;只能在設計模式下設定，因此僅限於範本層級，這代表內容作者無法修改這些值。
