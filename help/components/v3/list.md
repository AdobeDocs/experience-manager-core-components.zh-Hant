...
清單元件(v3)可用於建立子頁面的動態清單或任意定義專案的靜態清單。 可用的清單型別和格式設定選項可由範本作者在 [設計對話方塊](#design-dialog). 內容編輯器可以從可用的清單型別以及如何格式化中的清單元素 [編輯對話方塊](#edit-dialog).
...
![清單元件「編輯」對話方塊的「樣式」索引標籤](/help/assets/v3/list-edit-styles.png)
