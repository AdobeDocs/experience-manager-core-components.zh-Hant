...
導覽元件的目前版本是v2，此版本隨2022年2月的核心元件2.18.0版的發佈引入，具體說明見本文。
...
有關導覽元件的最新技術檔案 [可在GitHub上找到](https://adobe.com/go/aem_cmp_tech_navigation_v2).
...
![導覽元件「編輯」對話方塊的「樣式」索引標籤](/help/assets/navigation-edit-styles.png)
