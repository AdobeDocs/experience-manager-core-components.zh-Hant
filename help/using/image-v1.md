...
範本作者可在設計對話方塊中定義允許的影像寬度以及裁切和其 [他設定](image-v1.md#main-pars_title_1995166862)。 內容編輯器可以在「設定」對話方塊中上 [傳或選取資產](image-v1.md#main-pars_title_55926120) ，並在「編輯」對話方 [塊中裁切影像](image-v1.md#main-pars_title)。 為方便起見，酒店還提供簡單的就地修改影像。
...
>本檔案說明影像元件的v1。
>
>如需影像元件目前版本的詳細資訊，請參閱影 [像元件檔案](image.md) 。
...
除了標準的編輯 [對話框](image-v1.md#main-pars_title) 和設 [計對話框外](image-v1.md#main-pars_title_1995166862)，映像元件還提供配置對話框，其中定義了映像本身及其說明和基本屬性。
