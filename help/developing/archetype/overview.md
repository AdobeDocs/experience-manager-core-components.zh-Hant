...
| `groupId` |  | 基本Maven群組ID(例如 `"com.mysite"`)。 此值必須是 [有效的Java包名。](https://docs.oracle.com/javase/specs/jls/se6/html/packages.html#7.7) |
...
| `includeFormsheadless` | `n` | 包含 [Forms核心元件](https://github.com/adobe/aem-core-forms-components) 相依性， `ui.frontend.react.forms.af`，和無頭藏物。 |
