...
其中一個關鍵相依性是[AEM Java API Jar。](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/aem-as-a-cloud-service-sdk.html) 這將包括所有AEM API，而AEM版本只有一個相依專案。
