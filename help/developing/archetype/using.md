...
主要相依性之一是 [AEM Java API Jar](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/implementing/developing/aem-as-a-cloud-service-sdk.html)。 這樣一來，只要對該版本的 AEM 使用單一相依項目，就會包含所有 AEM API。
