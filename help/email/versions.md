...
電子郵件核心元件設計為具備彈性，並與所有支援的 AEM 版本相容。 您[可以在 GitHub 上找到](https://github.com/adobe/aem-core-email-components/releases)電子郵件核心元件之版本歷史記錄的完整詳細資訊。 不過，下表提供電子郵件核心元件的版本以及其與 AEM 發行版本和 Java 版本之相容性的概觀。
